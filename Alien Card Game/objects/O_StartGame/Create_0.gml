...
ini_write_string("Sources", "146", "The French you may hear in movies and television shows is not actually a real language! In fact, it was made for the sole purpose of being a language that is not able to be understood on TV.");
ini_write_string("Sources", "147", "Cereal in China is made with forks in mind. Their cereal is made out of a thicker grain that is easy to stab with a fork!");
ini_write_string("Sources", "148", "Bananas grow on trees. Thanks to gravity, they grow curved towards the ground!");
ini_write_string("Sources", "149", "Potato trees are common in certain parts of the world. Potato trees don’t need much sunlight to grow, making them an easy tree to grow!");
ini_write_string("Sources", "150", "In mythology, Ares is known as the god of the Underworld. He ruled it after he overthrew its old master, Zeus.");ini_write_string("Sources", "151", "The moon affects human behavior. Studies show there's a large correlation between the moon's phases and things like crime and mental health.");
...
ini_write_string("WebsiteNames", "1", "True Planet Facts");
ini_write_string("WebsiteNames", "2", "Interstellar Past");
ini_write_string("WebsiteNames", "3", "Empire Archive");
ini_write_string("WebsiteNames", "4", "Hidden History");
ini_write_string("WebsiteNames", "5", "The Erased Past");
...
ini_write_string("WebsiteNames", "18", "Just The Facts");
...
ini_write_string("WebsiteNames", "23", "Factual Opinions?!");
