...
draw_text_transformed(500, 20, string("SCORE: ") + string(global.ViewScore), 0.15, 0.15, 0);
...
draw_text_transformed(275, 20, string("COMBO: ") + string(global.ComboMult), 0.15, 0.15, 0);