...
//########################################################
function draw_text_scrolling_website(text_x, text_y, text_str, text_spd, text_slp, text_snd){
	...
	draw_text_ext_transformed(text_x, text_y, string_copy(text_str, 1, text_ind), 250, 4000, 0.15, 0.2, 0);
